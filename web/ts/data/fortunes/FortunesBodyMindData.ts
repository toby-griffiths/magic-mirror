...
export const FortunesBodyMindData: Fortune[] = [
    ...
    new Fortune("C", "B", "A", "You have a vintage advantage, ready for exploitation"),
    new Fortune("C", "B", "B", " Imagine yourself breathing the love that surrounds you right now, magnify it, and send it back out again"),
    ...
    new Fortune("D", "A", "B", "Get your wiggle on on the dancefloor"),
    new Fortune("D", "A", "C", "Go ask Cheryl for your Angel card of the day"),
    new Fortune("D", "A", "D", " Imagine yourself breathing the love that surrounds you right now, magnify it, and send it back out again"),
    new Fortune("D", "B", "A", "Go ask Cheryl for your Angel card of the day"),
    new Fortune("D", "B", "B", "Make every day like Sunday"),
    new Fortune("D", "B", "C", "What if the hokey pokey is what its all about?"),
